...
bfile=($(find /Users/danny/Library/Developer/Xcode/DerivedData -type d -name "VlcSdkRes.bundle" | xargs ls -ltrd | tail -1))
echo ${bfile[@]}
...
find /Users/danny/Library/Developer/Xcode/DerivedData -type d -name "VlcSdkRes.bundle" | xargs ls -ltrd | tail -1 | grep -o "/Users/.*" | xargs -I{} cp -R {} .
if [[ $? -ne 0 ]]
then
...
echo $(find /Users/danny/Library/Developer/Xcode/DerivedData -name "libVlcSdk.a" | xargs ls -ltr | grep universal | tail -1)
read -p "$(tput setaf 3)Enter to continue & copy, Ctrl-C quits.$(tput sgr0)" ui
find /Users/danny/Library/Developer/Xcode/DerivedData -name "libVlcSdk.a" | xargs ls -ltr | grep universal | tail -1 | grep -o "/Users/.*" | xargs -I{} cp {} .
if [[ $? -ne 0 ]]
then
    echo "$(tput setaf 1)Error copying bundle $(tput sgr0)"
	exit $?
